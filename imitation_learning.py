...
class ImitationLearning():
    ...
    def __init__(self, memory_fraction=0.25, image_cut=[115, 510],avoid_stopping=True):
    ...
    def _compute_action(self, rgb_image, speed, direction=None):
        ...
        scipy.misc.imsave('data1.png',rgb_image)
        rgb_image = rgb_image[self._image_cut[0]:self._image_cut[1], :]
        scipy.misc.imsave('data2.png',rgb_image)
        ...
        control = carla.VehicleControl(float(acc),float(steer),float(brake) )
        # control.steer = steer
